                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table card-table table-vcenter text-dark">
                                    <thead>
                                        <tr>
                                            <th class="text-dark w-1 desktop" style="font-size: 11px">Status</th>
                                            <th class="text-dark mobile-l mobile-p tablet-l tablet-p desktop" style="font-size: 11px">Nama Pelanggan</th>
                                            <th class="text-dark w-1 desktop" style="font-size: 11px">Tipe</th>
                                            <th class="text-dark w-1 desktop" style="font-size: 11px">Tarif</th>
                                            <th class="text-dark w-1 desktop" style="font-size: 11px">Jualan</th>
                                            <th class="text-dark w-1 desktop" style="font-size: 11px">Tgl Penagihan</th>
